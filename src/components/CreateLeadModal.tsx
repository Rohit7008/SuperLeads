    ...
    <Sheet open={true} onOpenChange={(open: boolean) => !open && onClose()}>
      <SheetContent side="right" className="sm:max-w-md w-full p-0 flex flex-col border-l border-border bg-white dark:bg-zinc-950">
        <SheetHeader className="px-6 pt-5 border-b border-border bg-zinc-50/50 dark:bg-zinc-900/50 text-left">
          <SheetTitle className="text-lg font-bold tracking-tight text-foreground">Add New Lead</SheetTitle>
        </SheetHeader>
          ...
          <div className="flex-1 overflow-y-auto p-6 pt-3 space-y-5 custom-scrollbar">
            ...
            <div className="grid grid-cols-1 gap-1">
              <div className="space-y-1.5">
                <Label htmlFor="name" className="text-[10px] font-bold uppercase tracking-widest text-muted-foreground ml-0.5">
                  Client Name
                </Label>
              ...
              <div className="space-y-1.5">
                <Label htmlFor="phone" className="text-[10px] font-bold uppercase tracking-widest text-muted-foreground ml-0.5">
                  Contact Number
                </Label>
                <div className="relative">
            ...
            <div className="space-y-1.5">
              <Label htmlFor="desc" className="text-[10px] font-bold uppercase tracking-widest text-muted-foreground ml-0.5">
                Client Overview
              </Label>
              <textarea
                id="desc"
